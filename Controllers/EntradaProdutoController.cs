...
namespace Projeto_Login.Controllers
{
    public class EntradaProdutoController : Controller
    {
        ...
        {
            ViewData["ProdutoId"] = new SelectList(_context.Set<Produto>(), "Id", "ProdutoNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,EntradaProdutoData,EntradaProdutoQuantidade")] EntradaProduto entradaProduto)
        {
            ...
            ViewData["ProdutoId"] = new SelectList(_context.Set<Produto>(), "Id", "ProdutoNome", entradaProduto.ProdutoId);
            return View(entradaProduto);
        }
