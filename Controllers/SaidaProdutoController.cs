...
namespace Projeto_Login.Controllers
{
    public class SaidaProdutoController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoSaidaId"] = new SelectList(_context.Set<TipoSaida>(), "Id", "TipoSaidaDescricao");
            ViewData["UsuarioId"] = new SelectList(_context.Set<Usuario>(), "Id", "NomeUsuario");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoId,SaidaProdutoData,SaidaProdutoQuantidade,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
            ...
            ViewData["TipoSaidaId"] = new SelectList(_context.Set<TipoSaida>(), "Id", "TipoSaidaDescricao", saidaProduto.TipoSaidaId);
            ViewData["UsuarioId"] = new SelectList(_context.Set<Usuario>(), "Id", "NomeUsuario", saidaProduto.UsuarioId);
            return View(saidaProduto);
        }
